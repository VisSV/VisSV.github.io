...
<head>
  ...
  <title data-ice="title">test/BrokenLinkChecker.spec.js | broken-link-checker-local API Document</title>
...
<div class="content" data-ice="content"><h1 data-ice="title">test/BrokenLinkChecker.spec.js</h1>
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">import expect from &apos;unexpected&apos;;
